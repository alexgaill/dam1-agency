 ...
 */
final class Version20220726123401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bien ADD COLUMN type_bien BOOLEAN NOT NULL');
        $this->addSql('ALTER TABLE bien ADD COLUMN image VARCHAR(40) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__bien AS SELECT id, titre, description, transaction_type, surface, surface_terrain, nb_pieces, etage, adresse, code_postal, ville, prix, date_construction FROM bien');
        ...
        $this->addSql('INSERT INTO bien (id, titre, description, transaction_type, surface, surface_terrain, nb_pieces, etage, adresse, code_postal, ville, prix, date_construction) SELECT id, titre, description, transaction_type, surface, surface_terrain, nb_pieces, etage, adresse, code_postal, ville, prix, date_construction FROM __temp__bien');
